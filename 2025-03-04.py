...
print()
print("Hello", myname, "Your ability to", superPower, "will make sure you never have to look at", enemyName, "again.") 
print("Go eat", food, "as you walk down the streets of", live, "and use", superPower, "for evil and not good!")
